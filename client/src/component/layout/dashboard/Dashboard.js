  ...
  return (
    <div> 

      {
        ...
        <button className="btn btn-primary" style={{marginBottom:'1em'}} onClick={ handleChange}>Go back</button> 
        <h1 className="text-primary">Dashboard</h1>
        <p>
          {" "}
          <i className="fa-solid fa-user"></i> Welcome{" "}
          <span className="text-primary">{capitalize(educationData.user.name)}</span>
        </p>
        <div className="dashboardLinkContainer">
          ...
          <Link to={`/add-education/${updatable}`} style={{ color: "white" }}>
            <button className="btnMain">
              {" "}
          ...
          <Link to={`/add-experience/${updatable}`} style={{ color: "white" }}>
            <button className="btnMain">
              {" "}
